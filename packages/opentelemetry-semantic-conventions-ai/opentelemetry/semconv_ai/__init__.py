...
class SpanAttributes:
    ...
    # LLM Workflows
    AUDITRAIL_SPAN_KIND = "auditrail.span.kind"
    AUDITRAIL_WORKFLOW_NAME = "auditrail.workflow.name"
    AUDITRAIL_ENTITY_NAME = "auditrail.entity.name"
    AUDITRAIL_ENTITY_PATH = "auditrail.entity.path"
    AUDITRAIL_ENTITY_VERSION = "auditrail.entity.version"
    AUDITRAIL_ENTITY_INPUT = "auditrail.entity.input"
    AUDITRAIL_ENTITY_OUTPUT = "auditrail.entity.output"
    AUDITRAIL_ASSOCIATION_PROPERTIES = "auditrail.association.properties"

    # Prompts
    AUDITRAIL_PROMPT_MANAGED = "auditrail.prompt.managed"
    AUDITRAIL_PROMPT_KEY = "auditrail.prompt.key"
    AUDITRAIL_PROMPT_VERSION = "auditrail.prompt.version"
    AUDITRAIL_PROMPT_VERSION_NAME = "auditrail.prompt.version_name"
    AUDITRAIL_PROMPT_VERSION_HASH = "auditrail.prompt.version_hash"
    AUDITRAIL_PROMPT_TEMPLATE = "auditrail.prompt.template"
    AUDITRAIL_PROMPT_TEMPLATE_VARIABLES = "auditrail.prompt.template_variables"

    # Deprecated
    AUDITRAIL_CORRELATION_ID = "auditrail.correlation.id"
...
class AuditrailSpanKindValues(Enum):
    WORKFLOW = "workflow"
    TASK = "task"
    AGENT = "agent"
    TOOL = "tool"
