...
class LangchainInstrumentor(BaseInstrumentor):
    ...
    def __init__(
        ...
        metadata_key_prefix: str = SpanAttributes.AUDITRAIL_ASSOCIATION_PROPERTIES
    ):
        ...
        Args:
            ...
            metadata_key_prefix: Prefix for metadata keys added to spans. Defaults to
                `SpanAttributes.AUDITRAIL_ASSOCIATION_PROPERTIES`.
    ...
    def _instrument(self, **kwargs):
        ...
        auditrailCallbackHandler = AuditrailCallbackHandler(
            tracer, duration_histogram, token_histogram
        )
        wrap_function_wrapper(
            module="langchain_core.callbacks",
            name="BaseCallbackManager.__init__",
            wrapper=_BaseCallbackManagerInitWrapper(auditrailCallbackHandler),
        )

        if not self.disable_trace_context_propagation:
            self._wrap_openai_functions_for_tracing(auditrailCallbackHandler)

    def _wrap_openai_functions_for_tracing(self, auditrailCallbackHandler):
        openai_tracing_wrapper = _OpenAITracingWrapper(auditrailCallbackHandler)
...
class _BaseCallbackManagerInitWrapper:
    def __init__(self, callback_handler: "AuditrailCallbackHandler"):
...
class _OpenAITracingWrapper:
    def __init__(self, callback_manager: "AuditrailCallbackHandler"):
