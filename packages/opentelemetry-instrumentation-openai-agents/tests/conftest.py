...
# Mock auditrail modules before any imports using proper ModuleType
SET_AGENT_NAME_MOCK = MagicMock()

# Create proper module mocks using types.ModuleType for better type safety
mock_auditrail = types.ModuleType('auditrail')
mock_sdk = types.ModuleType('auditrail.sdk')
mock_tracing = types.ModuleType('auditrail.sdk.tracing')
...
mock_auditrail.sdk = mock_sdk

# Install mocks in sys.modules before any imports occur
sys.modules['auditrail'] = mock_auditrail
sys.modules['auditrail.sdk'] = mock_sdk
sys.modules['auditrail.sdk.tracing'] = mock_tracing
