...
class OpenLLMetrySpanHandler(BaseSpanHandler[SpanHolder]):
    ...
    def new_span(
        ...
        **kwargs: Any,
        ...
        kind = (
            AuditrailSpanKindValues.TASK.value
            if parent
            else AuditrailSpanKindValues.WORKFLOW.value
        )
        ...
        span.set_attribute(SpanAttributes.AUDITRAIL_SPAN_KIND, kind)
        span.set_attribute(SpanAttributes.AUDITRAIL_ENTITY_NAME, span_name)
        try:
