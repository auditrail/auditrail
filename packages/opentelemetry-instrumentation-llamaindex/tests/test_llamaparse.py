...
def test_llamaparse_load_data_instrumentation(instrument_legacy, span_exporter):
    ...
    assert llamaparse_span.attributes[SpanAttributes.AUDITRAIL_SPAN_KIND] == AuditrailSpanKindValues.TASK.value
    assert llamaparse_span.attributes[SpanAttributes.AUDITRAIL_ENTITY_NAME] == "llamaparse"
