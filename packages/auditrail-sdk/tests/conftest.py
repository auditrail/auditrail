...
from auditrail.sdk.tracing.tracing import TracerWrapper
...
def exporter_with_no_metrics():
    ...
    os.environ["AUDITRAIL_METRICS_ENABLED"] = "false"
    ...
    if _trace_wrapper_instance:
        TracerWrapper.instance = _trace_wrapper_instance
        os.environ["AUDITRAIL_METRICS_ENABLED"] = "true"
...
def exporters_with_multiple_span_processors():
    ...
    # Get the default Auditrail processor
...
def datasets():
    ...
    api_key = os.environ.get("AUDITRAIL_API_KEY", "fake-key-for-vcr-playback")
    base_url = os.environ.get("AUDITRAIL_BASE_URL", "https://api-staging.auditrail.com")
