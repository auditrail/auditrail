...
from opentelemetry.semconv_ai import Meters, SpanAttributes, AuditrailSpanKindValues
    ...
    def __call__(self, wrapped, instance, args, kwargs):
        ...
        with self._tracer.start_as_current_span(
            ...
            try:
                ...
                span.set_attribute(
                    SpanAttributes.AUDITRAIL_SPAN_KIND,
                    AuditrailSpanKindValues.AGENT.value,
                )
                ...
                if args and should_send_prompts():
                    ...
                    span.set_attribute(
                        SpanAttributes.AUDITRAIL_ENTITY_INPUT, input_message
                    )
                ...
                if hasattr(result, "content") and should_send_prompts():
                    span.set_attribute(
                        SpanAttributes.AUDITRAIL_ENTITY_OUTPUT, str(result.content)
                    )
                ...
                self._duration_histogram.record(
                    ...
                    attributes={
                        ...
                        SpanAttributes.AUDITRAIL_SPAN_KIND: AuditrailSpanKindValues.AGENT.value,
                    },
                )
    ...
    def __call__(self, wrapped, instance, args, kwargs):
        ...
        with self._tracer.start_as_current_span(
            ...
            try:
                ...
                span.set_attribute(
                    SpanAttributes.AUDITRAIL_SPAN_KIND,
                    AuditrailSpanKindValues.WORKFLOW.value,
                )
                ...
                self._duration_histogram.record(
                    ...
                    attributes={
                        GenAIAttributes.GEN_AI_SYSTEM: "agno",
                        SpanAttributes.AUDITRAIL_SPAN_KIND: AuditrailSpanKindValues.WORKFLOW.value,
                    },
                )
