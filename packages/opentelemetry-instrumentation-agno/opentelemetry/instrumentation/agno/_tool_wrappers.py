    ...
    def __call__(self, wrapped, instance, args, kwargs):
        ...
        with self._tracer.start_as_current_span(
            ...
            try:
                ...
                span.set_attribute(SpanAttributes.AUDITRAIL_SPAN_KIND,
                                   AuditrailSpanKindValues.TOOL.value)
                span.set_attribute(SpanAttributes.AUDITRAIL_ENTITY_NAME, function_name)
                ...
                if should_send_prompts():
                    if hasattr(instance, 'arguments') and instance.arguments:
                        span.set_attribute(SpanAttributes.AUDITRAIL_ENTITY_INPUT,
                ...
                if result is not None and should_send_prompts():
                    span.set_attribute(SpanAttributes.AUDITRAIL_ENTITY_OUTPUT, str(result))
