"""
OpenAI Guardrails Example with Auditrail SDK
...
# Initialize Auditrail FIRST - before importing guardrails
Auditrail.init(app_name="openai-guardrails-example", disable_batch=True)
