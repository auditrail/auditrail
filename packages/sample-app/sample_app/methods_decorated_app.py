...
from auditrail.sdk.decorators import task, agent, workflow, tool
...
def joke_workflow():
    Auditrail.set_association_properties(
    ...
    auditrail_client = Auditrail.get()
    auditrail_client.user_feedback.create(
