...
appear as child spans under their parent agents in Auditrail.

Run with: python sample_handoff_app.py
Then view the traces in Auditrail to see the beautiful hierarchy!
"""
...
# Initialize Auditrail for observability
Auditrail.init(
    app_name="agent-handoff-demo",
    disable_batch=True,  # For immediate trace visibility
    api_endpoint=os.getenv("AUDITRAIL_API_ENDPOINT", "https://api.auditrail.com"),
    api_key=os.getenv("AUDITRAIL_API_KEY"),  # Set your Auditrail API key
)

print("🔧 Auditrail initialized!")
print("📊 Traces will be sent to Auditrail for visualization")
...
async def run_workflow_scenario(scenario_name: str, user_query: str):
    ...
    print("📊 Check Auditrail for the complete trace hierarchy!")
    print("-" * 80)
    ...
    try:
        ...
        print("📊 Check your Auditrail dashboard to see the handoff hierarchy:")
...
async def main():
    ...
    print("   export AUDITRAIL_API_KEY='your-auditrail-api-key'")
    print("   export OPENAI_API_KEY='your-openai-api-key'")
    print("\n🔗 View results at: https://app.auditrail.com/")
    ...
    if not os.getenv("AUDITRAIL_API_KEY"):
        print("\n⚠️  Warning: AUDITRAIL_API_KEY not set - traces won't be sent to Auditrail")
        print("   Set your API key: export AUDITRAIL_API_KEY='...'")
    ...
    print("📊 Check Auditrail dashboard to see the beautiful handoff hierarchy!")
    print("🔗 https://app.auditrail.com/")
...
if __name__ == "__main__":
    ...
    1. Set environment variables:
       ...
       export AUDITRAIL_API_KEY="your-auditrail-api-key"  # Optional

    2. Install dependencies:
       pip install openai-agents auditrail-sdk

    3. Run the demo:
       python sample_handoff_app.py

    4. View traces in Auditrail:
       https://app.auditrail.com/
    """
    asyncio.run(main())
