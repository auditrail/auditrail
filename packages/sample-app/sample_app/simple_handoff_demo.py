#!/usr/bin/env python3
"""
Simple OpenAI Agents Handoff Demo for Auditrail

A minimal example showing the fixed handoff hierarchy.
Run this to see perfect parent-child span relationships in Auditrail!
"""
...
# Initialize Auditrail with dashboard exporter
...
print("✅ Auditrail initialized - traces will appear in your dashboard!")
...
async def demo():
    ...
    print("📊 Check Auditrail to see the hierarchy!")
    ...
    print("\n✅ Demo complete!")
    print("📊 Expected trace hierarchy in Auditrail:")
    ...
    print("\n🔗 View at: https://app.auditrail.com/")
