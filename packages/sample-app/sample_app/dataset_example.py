"""
Example script demonstrating the Auditrail Dataset functionality
"""
...
from auditrail.sdk.datasets import Dataset, ColumnType, Column, Row
import pandas as pd
import openai


# Initialize Auditrail
client = Auditrail.init()
...
def main():
    print("Auditrail Dataset Examples")
    print("=" * 50)
