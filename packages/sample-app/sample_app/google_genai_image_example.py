...
# Initialize Auditrail SDK
Auditrail.init(app_name="google_genai_image_example")
...
try:
    ...
    print("=== Google GenAI Image Example with Auditrail ===")
...
print("\n✅ Done testing Google GenAI image support with Auditrail!")
