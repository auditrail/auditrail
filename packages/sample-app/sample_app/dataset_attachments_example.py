#!/usr/bin/env python3
"""
Sample application demonstrating how to use the attachment feature in Auditrail SDK.
...
from auditrail.sdk.datasets import (
    Attachment,
    Datasets,
    ExternalAttachment,
    FileCellType,
...
def example_external_attachments():
    ...
    # Initialize Auditrail
    Auditrail.init(app_name="attachment-demo")
    datasets = Datasets()
...
def main():
    """Run all examples."""
    print("=" * 60)
    print("Auditrail SDK Attachment Feature Examples")
    print("=" * 60)

    # Set your API key
    # os.environ["AUDITRAIL_API_KEY"] = "your-api-key-here"
    ...
    try:
        ...
        print(f"\nError: {e}")
        print("Make sure to set AUDITRAIL_API_KEY environment variable")
